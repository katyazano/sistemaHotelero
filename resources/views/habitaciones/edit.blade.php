    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-warning text-dark">
                <h4 class="mb-0"><i class="bi bi-pencil"></i> Editar Habitación #{{ $habitacion->numero }}</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('habitaciones.update', $habitacion->id_habitacion) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="tipo" id="tipo" required
                                ...
                                <option value="Sencilla" {{ old('tipo', $habitacion->tipo) == 'Sencilla' ? 'selected' : '' }}>Sencilla</option>
                                ...
                                <option value="Penthouse" {{ old('tipo', $habitacion->tipo) == 'Penthouse' ? 'selected' : '' }}>Penthouse</option>
                            </select>
                            @error('tipo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
